...
namespace Maze
{
    ...
    EditorSceneModeControllerScene::~EditorSceneModeControllerScene()
    {
        if (EditorSceneManager::GetInstancePtr())
            EditorSceneManager::GetInstancePtr()->getSceneAssetFileSaveEnabledChangedEvent().unsubscribe(this);
    ...
    //////////////////////////////////////////
    void EditorSceneModeControllerScene::shutdown()
    {
        if (m_canvasNode)
        {
    ...
    //////////////////////////////////////////
    ToggleButton2DPtr EditorSceneModeControllerScene::createBarButton(
    ...
    //////////////////////////////////////////
    void EditorSceneModeControllerScene::updateDebugAxes()
    {
        SceneMainToolsPtr const& scene = EditorManager::GetInstancePtr()->getSceneMainTools();
    ...
    //////////////////////////////////////////
    void EditorSceneModeControllerScene::updateDebugGrid()
    {
        SceneMainToolsPtr const& scene = EditorManager::GetInstancePtr()->getSceneMainTools();
    ...
    //////////////////////////////////////////
    void EditorSceneModeControllerScene::notifyDebugLightEnabledChanged(bool const& _value)
    {
        updateDebugLight();
    }

    //////////////////////////////////////////
    void EditorSceneModeControllerScene::notifyDebugAxesEnabledChanged(bool const& _value)
    {
        updateDebugAxes();
    }

    //////////////////////////////////////////
    void EditorSceneModeControllerScene::notifyDebugGridEnabledChanged(bool const& _value)
    {
        updateDebugGrid();
    }

    //////////////////////////////////////////
    void EditorSceneModeControllerScene::updateSaveButtonEnabled()
    {
        if (m_saveButton)
            m_saveButton->setEnabled(EditorSceneManager::GetInstancePtr()->getSceneAssetFileSaveEnabled());
    }

    //////////////////////////////////////////
    void EditorSceneModeControllerScene::notifyPrefabAssetFileSaveEnabledChanged(bool const& _value)
    {
        updateSaveButtonEnabled();
    }
