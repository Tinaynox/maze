...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeContextOpenALWin_hpp_))
#define _MazeContextOpenALWin_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ContextOpenALWin);
    ...
    //
    //////////////////////////////////////////
    class MAZE_SOUND_SYSTEM_OPENAL_API ContextOpenALWin
        : public ContextOpenAL
    {
    public:

        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ContextOpenALWin, ContextOpenAL);

    public:

        //////////////////////////////////////////
        virtual ~ContextOpenALWin();

        //////////////////////////////////////////
        static ContextOpenALWinPtr Create(
...
#endif // _MazeContextOpenALWin_hpp_
//////////////////////////////////////////
