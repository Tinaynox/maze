...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazePropertyDrawerRect2F_hpp_))
#define _MazePropertyDrawerRect2F_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(PropertyDrawerRect2F);
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API PropertyDrawerRect2F
        : public GenericPropertyDrawer<Rect2F>
        , public MultiDelegateCallbackReceiver
    {
    public:

        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(PropertyDrawerRect2F, PropertyDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(PropertyDrawerRect2F);
    ...
    public:
        ...
        //////////////////////////////////////////
        virtual void setValue(Rect2F const& _value) MAZE_OVERRIDE;

        //////////////////////////////////////////
        virtual Rect2F getValue() const MAZE_OVERRIDE;
...
#endif // _MazePropertyDrawerRect2F_hpp_
//////////////////////////////////////////
