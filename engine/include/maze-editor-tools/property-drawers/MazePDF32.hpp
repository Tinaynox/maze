...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazePropertyDrawerF32_hpp_))
#define _MazePropertyDrawerF32_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(PropertyDrawerF32);
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API PropertyDrawerF32
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(PropertyDrawerF32, PropertyDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(PropertyDrawerF32);

    public:

        //////////////////////////////////////////
        virtual ~PropertyDrawerF32();

        //////////////////////////////////////////
        static PropertyDrawerF32Ptr Create(DataBlock const& _dataBlock);
...
#endif // _MazePropertyDrawerF32_hpp_
//////////////////////////////////////////
