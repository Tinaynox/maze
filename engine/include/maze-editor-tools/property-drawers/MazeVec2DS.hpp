...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazePropertyDrawerVec2DS_hpp_))
#define _MazePropertyDrawerVec2DS_hpp_
...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API PropertyDrawerVec2DS
        : public GenericPropertyDrawer<Vec2DS>
        , public MultiDelegateCallbackReceiver
    {
    public:

        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(PropertyDrawerVec2DS, PropertyDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(PropertyDrawerVec2DS);

    public:

        //////////////////////////////////////////
        virtual ~PropertyDrawerVec2DS();

        //////////////////////////////////////////
        static PropertyDrawerVec2DSPtr Create(String const& _label);


        //////////////////////////////////////////
        virtual void setValue(Vec2DS const& _value) MAZE_OVERRIDE;

        //////////////////////////////////////////
        virtual Vec2DS getValue() const MAZE_OVERRIDE;
...
#endif // _MazePropertyDrawerVec2DS_hpp_
//////////////////////////////////////////
