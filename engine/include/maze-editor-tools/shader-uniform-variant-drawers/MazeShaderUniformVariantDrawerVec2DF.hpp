...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeShaderUniformVariantDrawerVec2DF_hpp_))
#define _MazeShaderUniformVariantDrawerVec2DF_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ShaderUniformVariantDrawerVec2DF);
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API ShaderUniformVariantDrawerVec2DF
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec2DF, ShaderUniformVariantDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ShaderUniformVariantDrawerVec2DF);

    public:

        //////////////////////////////////////////
        virtual ~ShaderUniformVariantDrawerVec2DF();

        //////////////////////////////////////////
        static ShaderUniformVariantDrawerVec2DFPtr Create(
    ...
    protected:
        ...
        //////////////////////////////////////////
        ShaderUniformVariantDrawerVec2DF();
...
#endif // _MazeShaderUniformVariantDrawerVec2DF_hpp_
//////////////////////////////////////////
