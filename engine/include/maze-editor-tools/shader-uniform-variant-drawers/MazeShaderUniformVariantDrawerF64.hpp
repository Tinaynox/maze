...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeShaderUniformVariantDrawerF64_hpp_))
#define _MazeShaderUniformVariantDrawerF64_hpp_
...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API ShaderUniformVariantDrawerF64
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerF64, MetaPropertyDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ShaderUniformVariantDrawerF64);

    public:

        //////////////////////////////////////////
        virtual ~ShaderUniformVariantDrawerF64();

        //////////////////////////////////////////
        static ShaderUniformVariantDrawerF64Ptr Create(
...
#endif // _MazeShaderUniformVariantDrawerF64_hpp_
//////////////////////////////////////////
