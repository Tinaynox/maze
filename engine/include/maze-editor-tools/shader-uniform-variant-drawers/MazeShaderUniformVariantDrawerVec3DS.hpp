...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeShaderUniformVariantDrawerVec3DS_hpp_))
#define _MazeShaderUniformVariantDrawerVec3DS_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ShaderUniformVariantDrawerVec3DS);
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API ShaderUniformVariantDrawerVec3DS
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec3DS, ShaderUniformVariantDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ShaderUniformVariantDrawerVec3DS);

    public:

        //////////////////////////////////////////
        virtual ~ShaderUniformVariantDrawerVec3DS();

        //////////////////////////////////////////
        static ShaderUniformVariantDrawerVec3DSPtr Create(
    ...
    protected:
        ...
        //////////////////////////////////////////
        ShaderUniformVariantDrawerVec3DS();
...
#endif // _MazeShaderUniformVariantDrawerVec3DS_hpp_
//////////////////////////////////////////
