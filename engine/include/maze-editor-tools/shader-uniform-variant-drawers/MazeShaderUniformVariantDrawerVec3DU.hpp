...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeShaderUniformVariantDrawerVec3DU_hpp_))
#define _MazeShaderUniformVariantDrawerVec3DU_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ShaderUniformVariantDrawerVec3DU);
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API ShaderUniformVariantDrawerVec3DU
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec3DU, ShaderUniformVariantDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ShaderUniformVariantDrawerVec3DU);

    public:

        //////////////////////////////////////////
        virtual ~ShaderUniformVariantDrawerVec3DU();

        //////////////////////////////////////////
        static ShaderUniformVariantDrawerVec3DUPtr Create(
    ...
    protected:
        ...
        //////////////////////////////////////////
        ShaderUniformVariantDrawerVec3DU();
...
#endif // _MazeShaderUniformVariantDrawerVec3DU_hpp_
//////////////////////////////////////////
