...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeShaderUniformVariantDrawerF32_hpp_))
#define _MazeShaderUniformVariantDrawerF32_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ShaderUniformVariantDrawerF32);
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API ShaderUniformVariantDrawerF32
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerF32, MetaPropertyDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ShaderUniformVariantDrawerF32);

    public:

        //////////////////////////////////////////
        virtual ~ShaderUniformVariantDrawerF32();

        //////////////////////////////////////////
        static ShaderUniformVariantDrawerF32Ptr Create(
...
#endif // _MazeShaderUniformVariantDrawerF32_hpp_
//////////////////////////////////////////
