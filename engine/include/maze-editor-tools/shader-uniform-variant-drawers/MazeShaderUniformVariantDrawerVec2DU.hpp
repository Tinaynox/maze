...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeShaderUniformVariantDrawerVec2DU_hpp_))
#define _MazeShaderUniformVariantDrawerVec2DU_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ShaderUniformVariantDrawerVec2DU);
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API ShaderUniformVariantDrawerVec2DU
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec2DU, ShaderUniformVariantDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ShaderUniformVariantDrawerVec2DU);

    public:

        //////////////////////////////////////////
        virtual ~ShaderUniformVariantDrawerVec2DU();

        //////////////////////////////////////////
        static ShaderUniformVariantDrawerVec2DUPtr Create(
    ...
    protected:
        ...
        //////////////////////////////////////////
        ShaderUniformVariantDrawerVec2DU();
...
#endif // _MazeShaderUniformVariantDrawerVec2DU_hpp_
//////////////////////////////////////////
