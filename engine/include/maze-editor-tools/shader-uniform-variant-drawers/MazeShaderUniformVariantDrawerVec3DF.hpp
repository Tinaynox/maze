...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeShaderUniformVariantDrawerVec3DF_hpp_))
#define _MazeShaderUniformVariantDrawerVec3DF_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ShaderUniformVariantDrawerVec3DF);
    ...
    //
    //////////////////////////////////////////
    class MAZE_EDITOR_TOOLS_API ShaderUniformVariantDrawerVec3DF
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec3DF, ShaderUniformVariantDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ShaderUniformVariantDrawerVec3DF);

    public:

        //////////////////////////////////////////
        virtual ~ShaderUniformVariantDrawerVec3DF();

        //////////////////////////////////////////
        static ShaderUniformVariantDrawerVec3DFPtr Create(
    ...
    protected:
        ...
        //////////////////////////////////////////
        ShaderUniformVariantDrawerVec3DF();
...
#endif // _MazeShaderUniformVariantDrawerVec3DF_hpp_
//////////////////////////////////////////
