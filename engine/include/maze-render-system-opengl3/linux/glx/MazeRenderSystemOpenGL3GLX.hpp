...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeRenderSystemOpenGL3GLX_hpp_))
#define _MazeRenderSystemOpenGL3GLX_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(RenderSystemOpenGL3GLX);
    MAZE_USING_SHARED_PTR(ContextOpenGL);


    //////////////////////////////////////////
    // Class RenderSystemOpenGL3GLX
    //
    //////////////////////////////////////////
    class MAZE_RENDER_SYSTEM_OPENGL3_API RenderSystemOpenGL3GLX
        : public RenderSystemOpenGL3
    {
    public:
    
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(RenderSystemOpenGL3GLX, RenderSystemOpenGL3);
    ...
    public:
        ...
        //////////////////////////////////////////
        virtual ~RenderSystemOpenGL3GLX();

        //////////////////////////////////////////
        static RenderSystemOpenGL3GLXPtr Create(RenderSystemOpenGLConfig const& _config);
...
#endif // _MazeRenderSystemOpenGL3GLX_hpp_
//////////////////////////////////////////
