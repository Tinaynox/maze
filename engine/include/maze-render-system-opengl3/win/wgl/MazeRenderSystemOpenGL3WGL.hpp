...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeRenderSystemOpenGL3WGL_hpp_))
#define _MazeRenderSystemOpenGL3WGL_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(RenderSystemOpenGL3WGL);
    MAZE_USING_SHARED_PTR(ContextOpenGL);


    //////////////////////////////////////////
    // Class RenderSystemOpenGL3WGL
    //
    //////////////////////////////////////////
    class MAZE_RENDER_SYSTEM_OPENGL3_API RenderSystemOpenGL3WGL 
        : public RenderSystemOpenGL3
    {
    public:

        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(RenderSystemOpenGL3WGL, RenderSystemOpenGL3);
    ...
    public:
        ...
        //////////////////////////////////////////
        virtual ~RenderSystemOpenGL3WGL();

        //////////////////////////////////////////
        static RenderSystemOpenGL3WGLPtr Create(RenderSystemOpenGLConfig const& _config);
...
#endif // _MazeRenderSystemOpenGL3WGL_hpp_
//////////////////////////////////////////
