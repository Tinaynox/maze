...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeRenderSystemOpenGL3NS_hpp_))
#define _MazeRenderSystemOpenGL3NS_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(RenderSystemOpenGL3NS);
    ...
    //
    //////////////////////////////////////////
    class MAZE_RENDER_SYSTEM_OPENGL3_API RenderSystemOpenGL3NS 
        : public RenderSystemOpenGL3
    {
    public:

        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(RenderSystemOpenGL3NS, RenderSystemOpenGL3);
    ...
    public:
        ...
        //////////////////////////////////////////
        virtual ~RenderSystemOpenGL3NS();

        //////////////////////////////////////////
        static RenderSystemOpenGL3NSPtr Create(RenderSystemOpenGLConfig const& _config);
...
#endif // _MazeRenderSystemOpenGL3NS_hpp_
//////////////////////////////////////////
