...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeBinarySerializable_hpp_))
#define _MazeBinarySerializable_hpp_
...
namespace Maze
{
    ...
    public:
        ...
        //////////////////////////////////////////
        virtual void serialize(U8* _data) const MAZE_ABSTRACT;

        //////////////////////////////////////////
        virtual void deserialize(U8 const* _data) MAZE_ABSTRACT;
    };
...
//////////////////////////////////////////
#endif // _MazeBinarySerializable_hpp_
