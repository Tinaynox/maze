...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeThreadWin_hpp_))
#define _MazeThreadWin_hpp_
...
namespace Maze
{
    ...
    public:
        ...
        ThreadWin(Delegate<S32> const& _entryPoint, TArg0 _arg0)
            : ThreadWin()
        {
            m_entryPoint = MakeUnique<TaskDelegate1>(_entryPoint, _arg0);
        }
        ...
        ThreadWin(Delegate<S32> const& _entryPoint, TArg0 _arg0, TArg1 _arg1)
            : ThreadWin()
        {
            m_entryPoint = MakeUnique<TaskDelegate2>(_entryPoint, _arg0, _arg1);
        }


        //////////////////////////////////////////
        ThreadWin(ThreadWin const&) = delete;
        
        //////////////////////////////////////////
        ThreadWin(ThreadWin&&) = delete;

        //////////////////////////////////////////
        ThreadWin& operator=(ThreadWin const&) = delete;
        
        //////////////////////////////////////////
        ThreadWin& operator=(ThreadWin&&) = delete;
