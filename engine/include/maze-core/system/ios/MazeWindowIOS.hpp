...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeWindowIOS_hpp_))
#define _MazeWindowIOS_hpp_
...
@class ViewIOS;
typedef ViewIOS* ViewIOSRef;

@class ViewControllerIOS;
typedef ViewControllerIOS* ViewControllerIOSRef;

@class WindowDelegateIOS;
typedef WindowDelegateIOS* WindowDelegateIOSRef;

#else

typedef void* ViewIOSRef;
typedef void* ViewControllerIOSRef;
typedef void* WindowDelegateIOSRef;
#endif
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(WindowIOS);
    MAZE_USING_SHARED_PTR(WindowParamsIOS);
    ...
    //
    //////////////////////////////////////////
    class MAZE_CORE_API WindowParamsIOS
        : public WindowParams
    {
    public:
    ...
    public:
        ...
        //////////////////////////////////////////
        void processWindowDelegateIOSWillClose();
        
        //////////////////////////////////////////
        void processWindowDelegateIOSDidBecomeKey();
        
        //////////////////////////////////////////
        void processWindowDelegateIOSDidResignKey();
        
        //////////////////////////////////////////
        void processOrientationChanged();
        
        //////////////////////////////////////////
        inline ViewIOSRef getViewIOS() { return m_viewIOS; }
        
        //////////////////////////////////////////
        inline ViewControllerIOSRef getViewControllerIOS() { return m_viewControllerIOS; }
    ...
    protected:
        ...
        //////////////////////////////////////////
        bool createWindowIOS();
        
        //////////////////////////////////////////
        void updateIOSWindow();
    ...
    protected:
        WindowDelegateIOSRef m_windowDelegateIOS;
        ViewIOSRef m_viewIOS;
        ViewControllerIOSRef m_viewControllerIOS;
    };
