...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeGPUTextureBufferOpenGL_hpp_))
#define _MazeGPUTextureBufferOpenGL_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(GPUTextureBufferOpenGL);
    MAZE_USING_SHARED_PTR(TextureOpenGL);
    ...
    //
    //////////////////////////////////////////
    class MAZE_RENDER_SYSTEM_OPENGL_CORE_API GPUTextureBufferOpenGL
        : public GPUTextureBuffer
    {
    public:
        ...
        //////////////////////////////////////////
        virtual ~GPUTextureBufferOpenGL();
    };
...
#endif // _MazeGPUTextureBufferOpenGL_hpp_
//////////////////////////////////////////
