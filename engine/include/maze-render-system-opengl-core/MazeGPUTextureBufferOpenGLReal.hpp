...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeGPUTextureBufferOpenGLReal_hpp_))
#define _MazeGPUTextureBufferOpenGLReal_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(GPUTextureBufferOpenGLReal);

    
    //////////////////////////////////////////
    // Class GPUTextureBufferOpenGLReal
    //
    //////////////////////////////////////////
    class MAZE_RENDER_SYSTEM_OPENGL_CORE_API GPUTextureBufferOpenGLReal
        : public GPUTextureBufferOpenGL
    {
    public:

        //////////////////////////////////////////
        GPUTextureBufferOpenGLReal(
            Vec2U const& _size,
        ...
        //////////////////////////////////////////
        virtual ~GPUTextureBufferOpenGLReal();
    };
...
#endif // _MazeGPUTextureBufferOpenGLReal_hpp_
//////////////////////////////////////////
