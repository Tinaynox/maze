...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeInstanceStreamModelMatrixOpenGL_hpp_))
#define _MazeInstanceStreamModelMatrixOpenGL_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(InstanceStreamModelMatrixOpenGL);


    //////////////////////////////////////////
    // Class InstanceStreamModelMatrixOpenGL
    //
    //////////////////////////////////////////
    class MAZE_RENDER_SYSTEM_OPENGL_CORE_API InstanceStreamModelMatrixOpenGL
        : public InstanceStreamModelMatrix
    {
    public:

        //////////////////////////////////////////
        static InstanceStreamModelMatrixOpenGLPtr Create(
            RenderSystemOpenGL* _rs,
            ContextOpenGL* _contextOpenGL,
            InstanceStreamModeOpenGL _mode);

        //////////////////////////////////////////
        ~InstanceStreamModelMatrixOpenGL();        
...
#endif // _MazeInstanceStreamModelMatrixOpenGL_hpp_
//////////////////////////////////////////
