...
namespace Maze
{
    ...
    protected:
        ...
        Size m_colorsStreamUniformHash = 0;
        Size m_colorsStreamTextureUniformHash = 0;
        Size m_colorsStreamTextureSizeUniformHash = 0;
        Size m_colorsStreamOffsetUniformHash = 0;
    };
