...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeMetaPropertyDrawerFOV_hpp_))
#define _MazeMetaPropertyDrawerFOV_hpp_
...
#include "maze-debugger/property-drawers/MazePropertyDrawerFOV.hpp"
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(MetaPropertyDrawerFOV);
    ...
    //
    //////////////////////////////////////////
    class MAZE_DEBUGGER_API MetaPropertyDrawerFOV
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(MetaPropertyDrawerFOV, MetaPropertyDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(MetaPropertyDrawerFOV);

    public:

        //////////////////////////////////////////
        virtual ~MetaPropertyDrawerFOV();

        //////////////////////////////////////////
        static MetaPropertyDrawerFOVPtr Create(MetaProperty* _metaProperty);
...
#endif // _MazeMetaPropertyDrawerFOV_hpp_
//////////////////////////////////////////
