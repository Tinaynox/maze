...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeMetaPropertyDrawerBool_hpp_))
#define _MazeMetaPropertyDrawerBool_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(MetaPropertyDrawerBool);
    ...
    //
    //////////////////////////////////////////
    class MAZE_DEBUGGER_API MetaPropertyDrawerBool
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(MetaPropertyDrawerBool, MetaPropertyDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(MetaPropertyDrawerBool);

    public:

        //////////////////////////////////////////
        virtual ~MetaPropertyDrawerBool();

        //////////////////////////////////////////
        static MetaPropertyDrawerBoolPtr Create(MetaProperty* _metaProperty);
    ...
    protected:
        PropertyDrawerBoolPtr m_drawer;
...
#endif // _MazeMetaPropertyDrawerBool_hpp_
//////////////////////////////////////////
