...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeMetaPropertyDrawerParticleSystem3DColorOverLifetimeModule_hpp_))
#define _MazeMetaPropertyDrawerParticleSystem3DColorOverLifetimeModule_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(MetaPropertyDrawerParticleSystem3DColorOverLifetimeModule);
    ...
    //
    //////////////////////////////////////////
    class MAZE_PARTICLES_API MetaPropertyDrawerParticleSystem3DColorOverLifetimeModule
    ...
    public:
        ...
        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(MetaPropertyDrawerParticleSystem3DColorOverLifetimeModule, MetaPropertyDrawer);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(MetaPropertyDrawerParticleSystem3DColorOverLifetimeModule);

    public:

        //////////////////////////////////////////
        virtual ~MetaPropertyDrawerParticleSystem3DColorOverLifetimeModule();

        //////////////////////////////////////////
        static MetaPropertyDrawerParticleSystem3DColorOverLifetimeModulePtr Create(MetaProperty* _metaProperty);
    ...
    protected:
        ...
        //////////////////////////////////////////
        MetaPropertyDrawerParticleSystem3DColorOverLifetimeModule();
    ...
    protected:
        ...
        PropertyDrawerParticleSystemParameterColorPtr m_parameterDrawer;
    };
...
#endif // _MazeMetaPropertyDrawerParticleSystem3DColorOverLifetimeModule_hpp_
//////////////////////////////////////////
