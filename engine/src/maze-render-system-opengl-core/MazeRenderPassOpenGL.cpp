...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    RenderPassOpenGL::RenderPassOpenGL()
    {
    }
    ...
    //////////////////////////////////////////
    RenderPassOpenGLPtr RenderPassOpenGL::Create(
        RenderSystem* _renderSystem,
        RenderPassType _passType,
        RenderPassDeleter const& _deleter)
    {
        RenderPassOpenGLPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR_EX(RenderPassOpenGL, object, _deleter, init(_renderSystem, _passType));
        return object;
    }
    ...
    {
        RenderPassOpenGLPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR_EX(RenderPassOpenGL, object, _deleter, init(_renderPass));
        return object;
    }

    //////////////////////////////////////////
    bool RenderPassOpenGL::init(
        RenderSystem* _renderSystem,
        RenderPassType _passType)
    {
    ...
    //////////////////////////////////////////
    RenderPassPtr RenderPassOpenGL::createCopy()
    {
        return RenderPassOpenGL::Create(cast<RenderPassOpenGL>());
    }
