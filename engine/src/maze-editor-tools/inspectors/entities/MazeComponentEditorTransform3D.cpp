...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS(ComponentEditorTransform3D);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(ComponentEditorTransform3D);

    //////////////////////////////////////////
    ComponentEditorTransform3D::ComponentEditorTransform3D()
    {
    ...
    //////////////////////////////////////////
    void ComponentEditorTransform3D::buildUI()
    {
        buildPropertyDrawer(
            getComponentMetaClass()->getProperty("localPosition"),
            "Position");

        buildPropertyDrawer(
            getComponentMetaClass()->getProperty("localRotation"),
            "Rotation");

        buildPropertyDrawer(
            getComponentMetaClass()->getProperty("localScale"),
            "Scale");
    }
