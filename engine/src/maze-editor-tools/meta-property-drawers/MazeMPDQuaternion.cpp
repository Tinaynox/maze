...
namespace Maze
{
    ...
    bool MetaPropertyDrawerQuaternion::init(MetaProperty* _metaProperty)
    {
        ...
        m_drawer = PropertyDrawerQuaternion::Create(data);
    ...
    ////////////////////////////////////////////
    void MetaPropertyDrawerQuaternion::unselectUI()
    {
        m_drawer->unselectUI();
    }
    ...
    void MetaPropertyDrawerQuaternion::processDataFromUI()
    {
        ...
        if (MetaClassHelper::IsValueEqual(q, m_metaProperty, m_metaInstances))
            return;


        if (m_useEditorActions && EditorToolsActionManager::GetInstancePtr())
            EditorActionHelper::SetValue(q, m_metaProperty, m_metaInstances);
        else
            MetaClassHelper::SetValue(q, m_metaProperty, m_metaInstances);
    }
