...
namespace Maze
{
    ...
    //////////////////////////////////////////
    // Class MetaPropertyDrawerFOV
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(MetaPropertyDrawerFOV, MetaPropertyDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(MetaPropertyDrawerFOV);

    //////////////////////////////////////////
    MetaPropertyDrawerFOV::MetaPropertyDrawerFOV()
    {
    ...
    //////////////////////////////////////////
    MetaPropertyDrawerFOVPtr MetaPropertyDrawerFOV::Create(MetaProperty* _metaProperty)
    {
        MetaPropertyDrawerFOVPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(MetaPropertyDrawerFOV, object, init(_metaProperty));
        return object;
    }

    //////////////////////////////////////////
    bool MetaPropertyDrawerFOV::init(MetaProperty* _metaProperty)
    {
        ...
        m_drawer = PropertyDrawerFOV::Create(data);
    ...
    //////////////////////////////////////////
    void MetaPropertyDrawerFOV::buildUI(
    ...
    //////////////////////////////////////////
    void MetaPropertyDrawerFOV::processDataToUI()
    {
        F32 value;
        bool isMultiValue;
    ...
    //////////////////////////////////////////
    void MetaPropertyDrawerFOV::processDataFromUI()
    {
