...
namespace Maze
{
    ...
    void SceneColorPicker::create2D()
    {
        ...
        m_finalColorRenderer = SpriteHelper::CreateSprite(
            ...
            Vec2F(0.0f, 0.0f),
            GraphicsManager::GetInstancePtr()->getDefaultRenderSystem()->getMaterialManager()->getBuiltinMaterial(
                BuiltinMaterialType::ColorStreamHDR)->createCopy(),
        ...
        m_hsvRectRenderer = SpriteHelper::CreateSprite(
            ...
            Vec2F(2.0f, 2.0f),
            GraphicsManager::GetInstancePtr()->getDefaultRenderSystem()->getMaterialManager()->getBuiltinMaterial(
                BuiltinMaterialType::HSVRect)->createCopy(),
        ...
        // R
        {
            ...
            m_rgbaRenderers[0] = SpriteHelper::CreateSprite(
                ...
                Vec2F(2.0f, 2.0f),
                GraphicsManager::GetInstancePtr()->getDefaultRenderSystem()->getMaterialManager()->getBuiltinMaterial(
                    BuiltinMaterialType::ColorPickerChannel)->createCopy(),
                border->getTransform(),
                this,
                Vec2F(0.0f, 0.0f),
                Vec2F(0.0f, 0.0f));
