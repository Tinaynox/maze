...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec2DS, ShaderUniformVariantDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(ShaderUniformVariantDrawerVec2DS);

    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec2DS::ShaderUniformVariantDrawerVec2DS()
    {
    ...
    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec2DSPtr ShaderUniformVariantDrawerVec2DS::Create(
        HashedCString _shaderUniformName,
        ShaderUniformType _shaderUniformType)
    {
        ShaderUniformVariantDrawerVec2DSPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(ShaderUniformVariantDrawerVec2DS, object, init(_shaderUniformName, _shaderUniformType));
        return object;
    }

    //////////////////////////////////////////
    bool ShaderUniformVariantDrawerVec2DS::init(
        HashedCString _shaderUniformName,
        ShaderUniformType _shaderUniformType)
    {
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2DS::buildUI(
    ...
    //////////////////////////////////////////
    SystemTextEditBox2DPtr ShaderUniformVariantDrawerVec2DS::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
        ...
        SystemTextEditBox2DPtr editBox = SystemUIHelper::CreateDefaultEditBox(
            ...
            Vec2DF(0.5f, 0.5f),
            Vec2DF::c_zero);
        editBox->eventTextInput.subscribe(this, &ShaderUniformVariantDrawerVec2DS::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &ShaderUniformVariantDrawerVec2DS::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2DS::notifyTextInput(SystemTextEditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2DS::notifySelectedChanged(SystemTextEditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2DS::processDataToUI()
    {
        ...
        if (!m_editBoxX->getSelected())
            m_editBoxX->setText(StringHelper::ToString(value.getVec2DS().x));

        if (!m_editBoxY->getSelected())
            m_editBoxY->setText(StringHelper::ToString(value.getVec2DS().y));

    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2DS::processDataFromUI()
    {
        Vec2DS value;
