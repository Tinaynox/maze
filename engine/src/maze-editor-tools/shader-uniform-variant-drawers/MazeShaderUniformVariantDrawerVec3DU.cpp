...
namespace Maze
{
    ...
    //////////////////////////////////////////
    EditBox2DPtr ShaderUniformVariantDrawerVec3DU::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3DU::notifyTextInput(EditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3DU::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
