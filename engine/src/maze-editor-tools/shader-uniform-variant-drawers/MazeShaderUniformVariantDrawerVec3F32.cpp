...
namespace Maze
{
    ...
    //////////////////////////////////////////
    // Class ShaderUniformVariantDrawerVec3F32
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec3F32, ShaderUniformVariantDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(ShaderUniformVariantDrawerVec3F32);

    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec3F32::ShaderUniformVariantDrawerVec3F32()
    {
    ...
    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec3F32Ptr ShaderUniformVariantDrawerVec3F32::Create(
        HashedCString _shaderUniformName,
        ShaderUniformType _shaderUniformType)
    {
        ShaderUniformVariantDrawerVec3F32Ptr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(ShaderUniformVariantDrawerVec3F32, object, init(_shaderUniformName, _shaderUniformType));
        return object;
    }

    //////////////////////////////////////////
    bool ShaderUniformVariantDrawerVec3F32::init(
        HashedCString _shaderUniformName,
        ShaderUniformType _shaderUniformType)
    {
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3F32::buildUI(
    ...
    //////////////////////////////////////////
    EditBox2DPtr ShaderUniformVariantDrawerVec3F32::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
        ...
        EditBox2DPtr editBox = SystemUIHelper::CreateDefaultEditBox(
            ...
            Vec2F(0.5f, 0.5f),
            Vec2F::c_zero);
        editBox->eventTextInput.subscribe(this, &ShaderUniformVariantDrawerVec3F32::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &ShaderUniformVariantDrawerVec3F32::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3F32::notifyTextInput(EditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3F32::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3F32::processDataToUI()
    {
        ...
        if (!m_editBoxX->getSelected())
            m_editBoxX->setText(StringHelper::F32ToStringFormatted(value.getVec3F32().x, 4));

        if (!m_editBoxY->getSelected())
            m_editBoxY->setText(StringHelper::F32ToStringFormatted(value.getVec3F32().y, 4));

        if (!m_editBoxZ->getSelected())
            m_editBoxZ->setText(StringHelper::F32ToStringFormatted(value.getVec3F32().z, 4));
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3F32::processDataFromUI()
    {
        Vec3F value;
