...
namespace Maze
{
    ...
    //////////////////////////////////////////
    SystemTextEditBox2DPtr ShaderUniformVariantDrawerVec4DU::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4DU::notifyTextInput(SystemTextEditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4DU::notifySelectedChanged(SystemTextEditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
