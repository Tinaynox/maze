...
namespace Maze
{
    ...
    //////////////////////////////////////////
    EditBox2DPtr ShaderUniformVariantDrawerVec2DU::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2DU::notifyTextInput(EditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2DU::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
