...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec4U32, ShaderUniformVariantDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(ShaderUniformVariantDrawerVec4U32);

    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec4U32::ShaderUniformVariantDrawerVec4U32()
    {
    ...
    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec4U32Ptr ShaderUniformVariantDrawerVec4U32::Create(
        HashedCString _shaderUniformName,
        ShaderUniformType _shaderUniformType)
    {
        ShaderUniformVariantDrawerVec4U32Ptr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(ShaderUniformVariantDrawerVec4U32, object, init(_shaderUniformName, _shaderUniformType));
        return object;
    }

    //////////////////////////////////////////
    bool ShaderUniformVariantDrawerVec4U32::init(
        HashedCString _shaderUniformName,
        ShaderUniformType _shaderUniformType)
    {
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4U32::buildUI(
    ...
    //////////////////////////////////////////
    EditBox2DPtr ShaderUniformVariantDrawerVec4U32::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
        ...
        EditBox2DPtr editBox = UIHelper::CreateDefaultEditBox(
            ...
            Vec2F(0.5f, 0.5f),
            Vec2F::c_zero);
        editBox->eventTextInput.subscribe(this, &ShaderUniformVariantDrawerVec4U32::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &ShaderUniformVariantDrawerVec4U32::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4U32::notifyTextInput(EditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4U32::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4U32::processDataToUI()
    {
        ...
        if (!m_editBoxX->getSelected())
            m_editBoxX->setText(StringHelper::ToString(value.getVec4F32().x));

        if (!m_editBoxY->getSelected())
            m_editBoxY->setText(StringHelper::ToString(value.getVec4F32().y));

        if (!m_editBoxZ->getSelected())
            m_editBoxZ->setText(StringHelper::ToString(value.getVec4F32().z));

        if (!m_editBoxW->getSelected())
            m_editBoxW->setText(StringHelper::ToString(value.getVec4F32().w));
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4U32::processDataFromUI()
    {
        Vec4F value;
