...
namespace Maze
{
    ...
    //////////////////////////////////////////
    // Class ShaderUniformVariantDrawerVec2S32
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec2S32, ShaderUniformVariantDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(ShaderUniformVariantDrawerVec2S32);

    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec2S32::ShaderUniformVariantDrawerVec2S32()
    {
    ...
    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec2S32Ptr ShaderUniformVariantDrawerVec2S32::Create(
        HashedCString _shaderUniformName,
        ShaderUniformType _shaderUniformType)
    {
        ShaderUniformVariantDrawerVec2S32Ptr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(ShaderUniformVariantDrawerVec2S32, object, init(_shaderUniformName, _shaderUniformType));
        return object;
    }

    //////////////////////////////////////////
    bool ShaderUniformVariantDrawerVec2S32::init(
        HashedCString _shaderUniformName,
        ShaderUniformType _shaderUniformType)
    {
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2S32::buildUI(
    ...
    //////////////////////////////////////////
    EditBox2DPtr ShaderUniformVariantDrawerVec2S32::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
        ...
        EditBox2DPtr editBox = UIHelper::CreateDefaultEditBox(
            ...
            Vec2F(0.5f, 0.5f),
            Vec2F::c_zero);
        editBox->eventTextInput.subscribe(this, &ShaderUniformVariantDrawerVec2S32::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &ShaderUniformVariantDrawerVec2S32::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2S32::notifyTextInput(EditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2S32::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2S32::processDataToUI()
    {
        ...
        if (!m_editBoxX->getSelected())
            m_editBoxX->setText(StringHelper::ToString(value.getVec2S32().x));

        if (!m_editBoxY->getSelected())
            m_editBoxY->setText(StringHelper::ToString(value.getVec2S32().y));

    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec2S32::processDataFromUI()
    {
        Vec2S value;
