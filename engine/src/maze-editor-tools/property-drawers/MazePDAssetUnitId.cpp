...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(PropertyDrawerAssetUnitId, PropertyDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(PropertyDrawerAssetUnitId);

    //////////////////////////////////////////
    PropertyDrawerAssetUnitId::PropertyDrawerAssetUnitId()
    {
    ...
    //////////////////////////////////////////
    PropertyDrawerAssetUnitIdPtr PropertyDrawerAssetUnitId::Create(DataBlock const& _dataBlock)
    {
        PropertyDrawerAssetUnitIdPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(PropertyDrawerAssetUnitId, object, init(_dataBlock));
        return object;
    }

    //////////////////////////////////////////
    bool PropertyDrawerAssetUnitId::init(DataBlock const& _dataBlock)
    {
    ...
    //////////////////////////////////////////
    void PropertyDrawerAssetUnitId::buildUI(
        ...
        CString _label)
    {
        ...
        m_dragAndDropZone->eventDragAndDrop.subscribe(
            [this](DataBlock const& _data, EntityId _viewEid)
            {
                if (_data.getHashedCString(MAZE_HCS("type")) == MAZE_HCS("assetUnit"))
                {
                    setValue(_data.getU32(MAZE_HCS("auid"), c_invalidAssetUnitId));
                    eventUIData();
                }
                else
                if (_data.getHashedCString(MAZE_HCS("type")) == MAZE_HCS("assetFile"))
                {
                    ...
                    if (assetFileId != c_invalidAssetFileId)
                    {
                        ...
                        if (assetFile)
                        {
                            setValue(assetFile->getFirstAssetUnit());
                            eventUIData();
                        }
                    }
                }
    ...
    ////////////////////////////////////////////
    void PropertyDrawerAssetUnitId::unselectUI()
    {
    ...
    void PropertyDrawerAssetUnitId::setValue(AssetUnitId const& _value)
    {
        ...
        m_text->setTextFormatted("%s [%u]", name, (U32)m_auid);
    }

    //////////////////////////////////////////
    AssetUnitId PropertyDrawerAssetUnitId::getValue() const
    {
        return m_auid;
    }
