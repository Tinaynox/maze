...
namespace Maze
{
    ...
    //////////////////////////////////////////
    PropertyDrawerRadiansPtr PropertyDrawerRadians::Create(DataBlock const& _dataBlock)
    {
        PropertyDrawerRadiansPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(PropertyDrawerRadians, object, init(_dataBlock));
        return object;
    }

    //////////////////////////////////////////
    bool PropertyDrawerRadians::init(DataBlock const& _dataBlock)
    {
    ...
    ////////////////////////////////////////////
    void PropertyDrawerRadians::unselectUI()
    {
