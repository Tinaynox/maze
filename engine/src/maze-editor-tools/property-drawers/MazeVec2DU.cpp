...
namespace Maze
{
    ...
    //////////////////////////////////////////
    EditBox2DPtr PropertyDrawerVec2DU::createS32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
    ...
    //////////////////////////////////////////
    void PropertyDrawerVec2DU::notifyTextInput(EditBox2D* _editBox)
    {
        eventUIData();
    }

    //////////////////////////////////////////
    void PropertyDrawerVec2DU::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            eventUIData();
