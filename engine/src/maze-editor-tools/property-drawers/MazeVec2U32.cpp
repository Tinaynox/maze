...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(PropertyDrawerVec2U32, PropertyDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(PropertyDrawerVec2U32);

    //////////////////////////////////////////
    PropertyDrawerVec2U32::PropertyDrawerVec2U32()
    {
    ...
    //////////////////////////////////////////
    PropertyDrawerVec2U32Ptr PropertyDrawerVec2U32::Create(String const& _label)
    {
        PropertyDrawerVec2U32Ptr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(PropertyDrawerVec2U32, object, init(_label));
        return object;
    }

    //////////////////////////////////////////
    bool PropertyDrawerVec2U32::init(String const& _label)
    {
    ...
    //////////////////////////////////////////
    void PropertyDrawerVec2U32::buildUI(
    ...
    //////////////////////////////////////////
    EditBox2DPtr PropertyDrawerVec2U32::createS32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
        ...
        EditBox2DPtr editBox = SystemUIHelper::CreateDefaultEditBox(
            ...
            Vec2F(0.5f, 0.5f),
            Vec2F::c_zero);
        editBox->eventTextInput.subscribe(this, &PropertyDrawerVec2U32::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &PropertyDrawerVec2U32::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void PropertyDrawerVec2U32::setString(String const& _value)
    {
        Vec2U value;
    ...
    //////////////////////////////////////////
    String PropertyDrawerVec2U32::getString()
    {
        String value;
    ...
    //////////////////////////////////////////
    void PropertyDrawerVec2U32::notifyTextInput(EditBox2D* _editBox)
    {
        eventUIData();
    }

    //////////////////////////////////////////
    void PropertyDrawerVec2U32::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            eventUIData();
    ...
    //////////////////////////////////////////
    void PropertyDrawerVec2U32::setValue(Vec2U const& _value)
    {
    ...
    //////////////////////////////////////////
    Vec2U PropertyDrawerVec2U32::getValue() const
    {
        Vec2U value;
