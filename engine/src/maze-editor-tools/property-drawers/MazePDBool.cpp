...
namespace Maze
{
    ...
    //////////////////////////////////////////
    PropertyDrawerBoolPtr PropertyDrawerBool::Create(DataBlock const& _dataBlock)
    {
        PropertyDrawerBoolPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(PropertyDrawerBool, object, init(_dataBlock));
        return object;
    }

    //////////////////////////////////////////
    bool PropertyDrawerBool::init(DataBlock const& _dataBlock)
    {
