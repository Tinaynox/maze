...
namespace Maze
{
    ...
    //////////////////////////////////////////
    // Class PropertyDrawerAABB2D
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(PropertyDrawerAABB2D, PropertyDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(PropertyDrawerAABB2D);

    //////////////////////////////////////////
    PropertyDrawerAABB2D::PropertyDrawerAABB2D()
    {
    ...
    //////////////////////////////////////////
    PropertyDrawerAABB2DPtr PropertyDrawerAABB2D::Create(DataBlock const& _dataBlock)
    {
        PropertyDrawerAABB2DPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(PropertyDrawerAABB2D, object, init(_dataBlock));
        return object;
    }

    //////////////////////////////////////////
    bool PropertyDrawerAABB2D::init(DataBlock const& _dataBlock)
    {
    ...
    //////////////////////////////////////////
    void PropertyDrawerAABB2D::buildUI(
    ...
    ////////////////////////////////////////////
    void PropertyDrawerAABB2D::unselectUI()
    {
    ...
    //////////////////////////////////////////
    EditBox2DPtr PropertyDrawerAABB2D::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        ...
        EditBox2DPtr editBox = UIHelper::CreateDefaultEditBox(
            ...
            Vec2F(0.5f, 0.5f),
            Vec2F::c_zero);
        editBox->eventTextInput.subscribe(this, &PropertyDrawerAABB2D::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &PropertyDrawerAABB2D::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void PropertyDrawerAABB2D::notifyTextInput(EditBox2D* _editBox)
    {
        eventUIData();
    }

    //////////////////////////////////////////
    void PropertyDrawerAABB2D::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            eventUIData();
    ...
    //////////////////////////////////////////
    void PropertyDrawerAABB2D::setValue(AABB2D const& _value)
    {
    ...
    //////////////////////////////////////////
    AABB2D PropertyDrawerAABB2D::getValue() const
    {
        AABB2D value;
