...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(PropertyDrawerVec4F32, PropertyDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(PropertyDrawerVec4F32);

    //////////////////////////////////////////
    PropertyDrawerVec4F32::PropertyDrawerVec4F32()
    {
    ...
    //////////////////////////////////////////
    PropertyDrawerVec4F32Ptr PropertyDrawerVec4F32::Create(DataBlock const& _dataBlock)
    {
        PropertyDrawerVec4F32Ptr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(PropertyDrawerVec4F32, object, init(_dataBlock));
        return object;
    }

    //////////////////////////////////////////
    bool PropertyDrawerVec4F32::init(DataBlock const& _dataBlock)
    {
    ...
    //////////////////////////////////////////
    void PropertyDrawerVec4F32::buildUI(
    ...
    ////////////////////////////////////////////
    void PropertyDrawerVec4F32::unselectUI()
    {
    ...
    //////////////////////////////////////////
    EditBox2DPtr PropertyDrawerVec4F32::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
        ...
        EditBox2DPtr editBox = UIHelper::CreateDefaultEditBox(
            ...
            Vec2F(0.5f, 0.5f),
            Vec2F::c_zero);
        editBox->eventTextInput.subscribe(this, &PropertyDrawerVec4F32::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &PropertyDrawerVec4F32::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void PropertyDrawerVec4F32::notifyTextInput(EditBox2D* _editBox)
    {
        eventUIData();
    }

    //////////////////////////////////////////
    void PropertyDrawerVec4F32::notifySelectedChanged(EditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            eventUIData();
    ...
    //////////////////////////////////////////
    void PropertyDrawerVec4F32::setValue(Vec4F32 const& _value)
    {
        ...
        if (!m_editBoxW->getSelected())
            m_editBoxW->setText(StringHelper::F32ToStringFormatted(_value.w, 4));
    }

    //////////////////////////////////////////
    Vec4F32 PropertyDrawerVec4F32::getValue() const
    {
        Vec4F32 value;
