...
namespace Maze
{
    ...
    //////////////////////////////////////////
    PropertyDrawerVec4F32Ptr PropertyDrawerVec4F32::Create(String const& _label)
    {
        PropertyDrawerVec4F32Ptr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(PropertyDrawerVec4F32, object, init(_label));
        return object;
    }

    //////////////////////////////////////////
    bool PropertyDrawerVec4F32::init(String const& _label)
    {
