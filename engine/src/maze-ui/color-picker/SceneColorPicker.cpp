...
namespace Maze
{
    ...
    void SceneColorPicker::create2D()
    {
        ...
        m_finalColorRenderer = SpriteHelper::CreateSprite(
            ...
            Vec2DF(0.0f, 0.0f),
            GraphicsManager::GetInstancePtr()->getDefaultRenderSystem()->getMaterialManager()->getColorHDRMaterial(),
        ...
        m_hsvRectRenderer = SpriteHelper::CreateSprite(
            ...
            Vec2DF(2.0f, 2.0f),
            GraphicsManager::GetInstancePtr()->getDefaultRenderSystem()->getMaterialManager()->getHSVRectMaterial(),
        ...
        m_hsvBandRenderer = SpriteHelper::CreateSprite(
            ...
            Vec2DF(2.0f, 2.0f),
            GraphicsManager::GetInstancePtr()->getDefaultRenderSystem()->getMaterialManager()->getHSVBandMaterial(),
        ...
        // R
        {
            ...
            m_rgbaRenderers[0] = SpriteHelper::CreateSprite(
                ...
                Vec2DF(2.0f, 2.0f),
                GraphicsManager::GetInstancePtr()->getDefaultRenderSystem()->getMaterialManager()->getColorPickerChannelMaterial(),
                border->getTransform(),
                this,
                Vec2DF(0.0f, 0.0f),
                Vec2DF(0.0f, 0.0f));
