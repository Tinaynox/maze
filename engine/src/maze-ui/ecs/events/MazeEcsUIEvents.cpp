...
{
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(ButtonClickEvent, Event,
        MAZE_IMPLEMENT_METACLASS_PROPERTY(EntityId, buttonEid, c_invalidEntityId, getButtonEid, setButtonEid),
