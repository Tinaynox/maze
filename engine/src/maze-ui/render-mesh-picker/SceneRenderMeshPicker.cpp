...
namespace Maze
{
    ...
    void SceneRenderMeshPicker::create2D()
    {
        ...
        RenderMeshPtr const& material = RenderMeshPickerManager::GetInstancePtr()->getRenderMesh();
    ...
    //////////////////////////////////////////
    void SceneRenderMeshPicker::notifyCanvasCursorReleaseIn(Vec2DF const& _positionOS, CursorInputEvent const& _event)
    {
