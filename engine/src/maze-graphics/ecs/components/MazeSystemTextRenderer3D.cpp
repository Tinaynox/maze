...
namespace Maze
{
    ...
    void SystemTextRenderer3D::updateMeshData()
    {
        ...
        while (*p != 0)
        {
            ...
            else
            {
                ...
                Mat4F localTransform = Mat4F::CreateScaleMatrix(0.01f) * Mat4F::CreateTranslationMatrix(positionShiftV) * Mat4F::CreateScaleMatrix(sizeV);
    ...
    //////////////////////////////////////////
    SIMPLE_COMPONENT_SYSTEM_EVENT_HANDLER(SystemTextRenderer3DSystem, {},
