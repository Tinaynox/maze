...
namespace Maze
{
    ...
    //////////////////////////////////////////
    // Class MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule, MetaPropertyDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule);

    //////////////////////////////////////////
    MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule::MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule()
    {
    ...
    //////////////////////////////////////////
    MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModulePtr MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule::Create(MetaProperty* _metaProperty)
    {
        MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModulePtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule, object, init(_metaProperty));
        return object;
    }

    //////////////////////////////////////////
    bool MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule::init(MetaProperty* _metaProperty)
    {
        if (!MetaPropertyDrawer::init(_metaProperty))
            return false;

        m_enabledDrawer = PropertyDrawerBool::Create("Size over Lifetime");
        m_enabledDrawer->eventUIData.subscribe(this, &MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule::processDataFromUI);

        m_parameterDrawer = PropertyDrawerParticleSystemParameterF32Positive::Create("Size");
        m_parameterDrawer->eventUIData.subscribe(this, &MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule::processDataFromUI);

        return true;
    }

    //////////////////////////////////////////
    void MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule::buildUI(
    ...
    //////////////////////////////////////////
    void MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule::processDataToUI()
    {
        ParticleSystem3DMainModule::SizeOverLifetimeModule value;
        bool isMultiValue;
    ...
    //////////////////////////////////////////
    void MetaPropertyDrawerParticleSystem3DSizeOverLifetimeModule::processDataFromUI()
    {
        ParticleSystem3DMainModule::SizeOverLifetimeModule value;
