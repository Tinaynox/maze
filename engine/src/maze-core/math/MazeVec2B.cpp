...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    Vec2B const Vec2B::c_false = { false, false };
    Vec2B const Vec2B::c_true = { true, true };

    //////////////////////////////////////////
    String Vec2B::toString(Char _separator) const
    {
        return StringHelper::ToString(x) + _separator + StringHelper::ToString(y);
    }

    //////////////////////////////////////////
    CString Vec2B::ParseString(CString _string, Size _size, Vec2B& _result, Char _separator)
    {
    ...
    //////////////////////////////////////////
    CString Vec2B::ParseStringPretty(CString _string, Size _size, Vec2B& _result, Char _separator)
    {
        CString end = _string + _size;
    ...
    //////////////////////////////////////////
    Vec2B Vec2B::FromString(CString _string, Size _size, Char _separator)
    {
        Vec2B result = Vec2B(false);
        ParseString(_string, _size, result, _separator);
        return result;
    }

    //////////////////////////////////////////
    Vec2B Vec2B::FromString(String const& _string, Char _separator)
    {
