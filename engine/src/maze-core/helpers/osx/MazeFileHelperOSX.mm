...
#include "maze-core/helpers/osx/MazeFileHelperOSX.hpp"
...
namespace Maze
{
    ...
    namespace FileHelper
    {
        ...
        MAZE_CORE_API Path GetBinaryFullPath()
        {
            ...
            return NormalizedFilePath(pathbuf);
        }
        ...
        MAZE_CORE_API Path GetDocumentsDirectory()
        {
            ...
            return NormalizedFilePath(path) + "/Contents";
        }
        ...
        MAZE_CORE_API Path GetDefaultLogDirectory()
        {
            ...
            //return NormalizedFilePath(path) + "/Contents/Log";
            return NormalizedFilePath(path) + "/..";
        }
