...
#include "maze-core/system/android/MazeDynLibAndroid.hpp"
...
namespace Maze
{
    ...
    //////////////////////////////////////////
    void* DynLibAndroid::getSymbol(String const& _symbolName)
    {
