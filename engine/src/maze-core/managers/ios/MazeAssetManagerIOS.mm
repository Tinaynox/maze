...
#include "maze-core/managers/ios/MazeAssetManagerIOS.hpp"
...
{
    //////////////////////////////////////////
    // Class AssetManagerIOS
    //
    //////////////////////////////////////////
    AssetManagerIOS::AssetManagerIOS()
    {
    }
    ...
    //////////////////////////////////////////
    bool AssetManagerIOS::init(DataBlock const& _config)
    {
    ...
    //////////////////////////////////////////
    Path AssetManagerIOS::getDefaultAssetsDirectory()
    {
        ...
        if (s_defaultAssetsDirectory.empty())
        {
            ...
            s_defaultAssetsDirectory = path + Path("/Contents/Assets/");
        }
