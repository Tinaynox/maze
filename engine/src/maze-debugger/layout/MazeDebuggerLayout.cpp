...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    F32 const DebuggerLayout::c_titleHeight = 20.0f;
    ColorU32 const DebuggerLayout::c_titleBackgroundColor = ColorU32(203, 203, 203, 255);
    U32 const DebuggerLayout::c_titleFontSize = 10;
    F32 const DebuggerLayout::c_titleLabelShift = 5.0f;
    ColorU32 const DebuggerLayout::c_bodyBackgroundColor = ColorU32(194, 194, 194, 255);
    U32 const DebuggerLayout::c_inspectorPropertyFontSize = 8;
    ColorU32 const DebuggerLayout::c_inspectorPropertyColor = ColorU32(32, 32, 32, 255);
    Rect2DF const DebuggerLayout::c_hierarchyViewport(0.0f, 0.33f, 0.25f, 0.67f);
