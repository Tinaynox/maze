...
namespace Maze
{
    ...
    //////////////////////////////////////////
    // Class ShaderUniformVariantDrawerVec3DS
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec3DS, ShaderUniformVariantDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(ShaderUniformVariantDrawerVec3DS);

    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec3DS::ShaderUniformVariantDrawerVec3DS()
    {
        ...
        ShaderUniformType _shaderUniformType)
    {
        ...
        MAZE_CREATE_AND_INIT_SHARED_PTR(ShaderUniformVariantDrawerVec3DS, object, init(_shaderUniformName, _shaderUniformType));
        return object;
    }
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3DS::buildUI(
    ...
    //////////////////////////////////////////
    SystemTextEditBox2DPtr ShaderUniformVariantDrawerVec3DS::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        RenderSystemPtr const& renderSystem = GraphicsManager::GetInstancePtr()->getDefaultRenderSystem();
        ...
        SystemTextEditBox2DPtr editBox = UIHelper::CreateDefaultEditBox(
            ...
            Vec2DF(0.5f, 0.5f),
            Vec2DF::c_zero);
        editBox->eventTextInput.subscribe(this, &ShaderUniformVariantDrawerVec3DS::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &ShaderUniformVariantDrawerVec3DS::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3DS::notifyTextInput(SystemTextEditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3DS::notifySelectedChanged(SystemTextEditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3DS::processDataToUI()
    {
        ...
        if (!m_editBoxX->getSelected())
            m_editBoxX->setText(StringHelper::ToString(value.getVec3DS().x));

        if (!m_editBoxY->getSelected())
            m_editBoxY->setText(StringHelper::ToString(value.getVec3DS().y));

        if (!m_editBoxZ->getSelected())
            m_editBoxZ->setText(StringHelper::ToString(value.getVec3DS().z));
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec3DS::processDataFromUI()
    {
        Vec3DS value;
