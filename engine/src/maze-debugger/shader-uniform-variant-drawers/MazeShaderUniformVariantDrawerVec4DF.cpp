...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(ShaderUniformVariantDrawerVec4DF, ShaderUniformVariantDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(ShaderUniformVariantDrawerVec4DF);

    //////////////////////////////////////////
    ShaderUniformVariantDrawerVec4DF::ShaderUniformVariantDrawerVec4DF()
    {
        ...
        ShaderUniformType _shaderUniformType)
    {
        ...
        MAZE_CREATE_AND_INIT_SHARED_PTR(ShaderUniformVariantDrawerVec4DF, object, init(_shaderUniformName, _shaderUniformType));
        return object;
    }
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4DF::buildUI(
    ...
    //////////////////////////////////////////
    SystemTextEditBox2DPtr ShaderUniformVariantDrawerVec4DF::createF32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        HorizontalLayout2DPtr layout = UIHelper::CreateHorizontalLayout(
        ...
        SystemTextEditBox2DPtr editBox = UIHelper::CreateDefaultEditBox(
            ...
            Vec2DF(0.5f, 0.5f),
            Vec2DF::c_zero);
        editBox->eventTextInput.subscribe(this, &ShaderUniformVariantDrawerVec4DF::notifyTextInput);
        editBox->eventSelectedChanged.subscribe(this, &ShaderUniformVariantDrawerVec4DF::notifySelectedChanged);

        return editBox;
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4DF::notifyTextInput(SystemTextEditBox2D* _editBox)
    {
        processDataFromUI();
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4DF::notifySelectedChanged(SystemTextEditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            processDataFromUI();
    ...
    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4DF::processDataToUI()
    {
        ...
        if (!m_editBoxX->getSelected())
            m_editBoxX->setText(StringHelper::F32ToStringFormatted(value.getVec4DF().x, 4));

        if (!m_editBoxY->getSelected())
            m_editBoxY->setText(StringHelper::F32ToStringFormatted(value.getVec4DF().y, 4));

        if (!m_editBoxZ->getSelected())
            m_editBoxZ->setText(StringHelper::F32ToStringFormatted(value.getVec4DF().z, 4));

        if (!m_editBoxW->getSelected())
            m_editBoxW->setText(StringHelper::F32ToStringFormatted(value.getVec4DF().w, 4));
    }

    //////////////////////////////////////////
    void ShaderUniformVariantDrawerVec4DF::processDataFromUI()
    {
        Vec4DF value;
