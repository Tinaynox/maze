...
namespace Maze
{
    ...
    //////////////////////////////////////////
    SystemTextEditBox2DPtr PropertyDrawerVec2DS::createS32Edit(
        CString _name,
        Transform2DPtr const& _parent)
    {
        RenderSystemPtr const& renderSystem = GraphicsManager::GetInstancePtr()->getDefaultRenderSystem();
    ...
    //////////////////////////////////////////
    void PropertyDrawerVec2DS::notifyTextInput(SystemTextEditBox2D* _editBox)
    {
        eventUIData();
    }

    //////////////////////////////////////////
    void PropertyDrawerVec2DS::notifySelectedChanged(SystemTextEditBox2D* _editBox, bool _selected)
    {
        if (!_selected)
        {
            eventUIData();
