...
namespace Maze
{
    ...
    //////////////////////////////////////////
    PlayerPtr Player::Create(S32 _playerIndex)
    {
        PlayerPtr playerGamepad;
        MAZE_CREATE_AND_INIT_SHARED_PTR(Player, playerGamepad, init(_playerIndex));
        return playerGamepad;
    }

    //////////////////////////////////////////
    bool Player::init(S32 _playerIndex)
    {
        m_playerIndex = _playerIndex;

        m_playerGamepad = PlayerGamepad::Create(m_playerIndex);
