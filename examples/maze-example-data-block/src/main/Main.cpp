...
S32 main(S32 _argc, S8 const* _argv[])
{
    ...
    vectorsBlock->addVec2B(MAZE_HS("vec2bValue"), vec2dbValue);
    vectorsBlock->addVec3B(MAZE_HS("vec3bValue"), vec3dbValue);
    vectorsBlock->addVec4B(MAZE_HS("vec4bValue"), vec4dbValue);
    vectorsBlock->addVec2S32(MAZE_HS("vec2sValue"), vec2dsValue);
    vectorsBlock->addVec3S32(MAZE_HS("vec3sValue"), vec3dsValue);
    vectorsBlock->addVec4S32(MAZE_HS("vec4sValue"), vec4dsValue);
    vectorsBlock->addVec2U32(MAZE_HS("vec2uValue"), vec2duValue);
    vectorsBlock->addVec3U32(MAZE_HS("vec3uValue"), vec3duValue);
    vectorsBlock->addVec4U32(MAZE_HS("vec4uValue"), vec4duValue);
    vectorsBlock->addVec2F32(MAZE_HS("vec2fValue"), vec2dfValue);
    vectorsBlock->addVec3F32(MAZE_HS("vec3fValue"), vec3dfValue);
    vectorsBlock->addVec4F32(MAZE_HS("vec4fValue"), vec4dfValue);
    ...
    auto validateBuffer =
        [&](DataBlock& _dataBlock)
        {
            ...
            auto v07 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec2B(MAZE_HS("vec2bValue")); MAZE_ASSERT(v07 == vec2dbValue);
            auto v08 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec3B(MAZE_HS("vec3bValue")); MAZE_ASSERT(v08 == vec3dbValue);
            auto v09 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec4B(MAZE_HS("vec4bValue")); MAZE_ASSERT(v09 == vec4dbValue);
            auto v10 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec2S32(MAZE_HS("vec2sValue")); MAZE_ASSERT(v10 == vec2dsValue);
            auto v11 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec3S32(MAZE_HS("vec3sValue")); MAZE_ASSERT(v11 == vec3dsValue);
            auto v12 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec4S32(MAZE_HS("vec4sValue")); MAZE_ASSERT(v12 == vec4dsValue);
            auto v13 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec2U32(MAZE_HS("vec2uValue")); MAZE_ASSERT(v13 == vec2duValue);
            auto v14 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec3U32(MAZE_HS("vec3uValue")); MAZE_ASSERT(v14 == vec3duValue);
            auto v15 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec4U32(MAZE_HS("vec4uValue")); MAZE_ASSERT(v15 == vec4duValue);
            auto v16 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec2F32(MAZE_HS("vec2fValue")); MAZE_ASSERT(v16 == vec2dfValue);
            auto v17 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec3F32(MAZE_HS("vec3fValue")); MAZE_ASSERT(v17 == vec3dfValue);
            auto v18 = _dataBlock[MAZE_HS("subBlock")][MAZE_HS("vectors")].getVec4F32(MAZE_HS("vec4fValue")); MAZE_ASSERT(v18 == vec4dfValue);
