...
python3 "$MAZE_ENGINE_DIR/../examples/templates/resources/make_data.py" --src "$RESOURCES_X1_DIR" --dst "$RESOURCES_X1_NC_DIR" --tools "$MAZE_ENGINE_DIR/../third-party/tools" --temp "$PRJ_ROOT_DIR/resources/.temp" --cache cache-win-x1.0-nc.pkl