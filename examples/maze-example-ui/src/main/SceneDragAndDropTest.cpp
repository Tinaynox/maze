...
//////////////////////////////////////////
#include "SceneDragAndDropTest.hpp"
...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(SceneDragAndDropTest, EcsRenderScene);

    //////////////////////////////////////////
    SceneDragAndDropTest::SceneDragAndDropTest()
    {
    }
    ...
    //////////////////////////////////////////
    SceneDragAndDropTestPtr SceneDragAndDropTest::Create()
    {
        SceneDragAndDropTestPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(SceneDragAndDropTest, object, init());
        return object;
    }

    //////////////////////////////////////////
    bool SceneDragAndDropTest::init()
    {
    ...
    //////////////////////////////////////////
    void SceneDragAndDropTest::notifyMainRenderWindowViewportChanged(Rect2F const& _mainRenderWindowViewport)
    {
        m_canvas->setViewport(Example::GetInstancePtr()->getMainRenderWindowViewport());
    }

    //////////////////////////////////////////
    void SceneDragAndDropTest::update(F32 _dt)
    {
    ...
    //////////////////////////////////////////
    void SceneDragAndDropTest::create3D()
    {
        InputManager* inputManager = InputManager::GetInstancePtr();
        ...
        Example::GetInstancePtr()->eventMainRenderWindowViewportChanged.subscribe(this, &SceneDragAndDropTest::notifyMainRenderWindowViewportChanged);

    }

    //////////////////////////////////////////
    void SceneDragAndDropTest::create2D()
    {
        RenderSystemPtr const& renderSystem = GraphicsManager::GetInstancePtr()->getDefaultRenderSystem();
        ShaderSystemPtr const& shaderSystem = renderSystem->getShaderSystem();
        SpriteManagerPtr const& spriteManager = renderSystem->getSpriteManager();
    ...
    //////////////////////////////////////////
    InventorySlotPtr SceneDragAndDropTest::createSlot(Vec2F const& _pos)
    {
    ...
    //////////////////////////////////////////
    InventoryItemPtr SceneDragAndDropTest::createItem()
    {
