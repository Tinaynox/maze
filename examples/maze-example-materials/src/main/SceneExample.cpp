...
namespace Maze
{
    ...
    bool SceneExample::init()
    {
        ...
        addMeshPreview("Cube", "Raymarching00.mzmaterial", "Ray Marching", 1.5f);
        addMeshPreviewSpace();
        ...
        F32 _scale)
    {
        ...
        if (meshAssetFile)
            mesh = MeshManager::GetInstancePtr()->loadMesh(meshAssetFile);
        else        
            mesh = MeshManager::GetInstancePtr()->getBuiltinMesh(BuiltinMeshType::FromString(_meshName));
