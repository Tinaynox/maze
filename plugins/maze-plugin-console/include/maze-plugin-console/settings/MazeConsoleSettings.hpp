...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeConsoleSettings_hpp_))
#define _MazeConsoleSettings_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ConsoleSettings);

    //////////////////////////////////////////
    // Class ConsoleSettings
    //
    //////////////////////////////////////////
    class MAZE_PLUGIN_CONSOLE_API ConsoleSettings
        : public Settings
    {
    public:

        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ConsoleSettings, Settings);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ConsoleSettings);
...
#endif // _MazeConsoleSettings_hpp_
//////////////////////////////////////////
