...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(ProfilerViewSettings, Settings,
        MAZE_IMPLEMENT_METACLASS_PROPERTY(bool, active, false, getActive, setActive));

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(ProfilerViewSettings);

    //////////////////////////////////////////
    ProfilerViewSettings::ProfilerViewSettings()
        : m_active(false)
    {
