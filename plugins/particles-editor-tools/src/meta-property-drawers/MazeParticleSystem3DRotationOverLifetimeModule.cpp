...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule, MetaPropertyDrawer);

    //////////////////////////////////////////
    MAZE_IMPLEMENT_MEMORY_ALLOCATION_BLOCK(MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule);

    //////////////////////////////////////////
    MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule::MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule()
    {
    ...
    //////////////////////////////////////////
    MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModulePtr MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule::Create(MetaProperty* _metaProperty)
    {
        MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModulePtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule, object, init(_metaProperty));
        return object;
    }

    //////////////////////////////////////////
    bool MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule::init(MetaProperty* _metaProperty)
    {
    ...
    //////////////////////////////////////////
    void MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule::buildUI(
    ...
    //////////////////////////////////////////
    void MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule::processDataToUI()
    {
        ParticleSystem3DMainModule::RotationOverLifetimeModule value;
        bool isMultiValue;
    ...
    //////////////////////////////////////////
    void MetaPropertyDrawerParticleSystem3DRotationOverLifetimeModule::processDataFromUI()
    {
