...
namespace Maze
{
    ...
    //
    //////////////////////////////////////////
    MAZE_IMPLEMENT_METACLASS_WITH_PARENT(SceneProfiler, ECSRenderScene);
    ...
    //////////////////////////////////////////
    SceneProfilerPtr SceneProfiler::Create(RenderTargetPtr const& _renderTarget)
    {
        SceneProfilerPtr object;
        MAZE_CREATE_AND_INIT_SHARED_PTR(SceneProfiler, object, init(_renderTarget));
        return object;
    }

    //////////////////////////////////////////
    bool SceneProfiler::init(RenderTargetPtr const& _renderTarget)
    {
