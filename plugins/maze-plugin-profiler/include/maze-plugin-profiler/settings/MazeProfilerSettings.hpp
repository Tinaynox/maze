...
//////////////////////////////////////////
#pragma once
#if (!defined(_MazeProfilerSettings_hpp_))
#define _MazeProfilerSettings_hpp_
...
{
    //////////////////////////////////////////
    MAZE_USING_SHARED_PTR(ProfilerSettings);

    //////////////////////////////////////////
    // Class ProfilerSettings
    //
    //////////////////////////////////////////
    class MAZE_PLUGIN_PROFILER_API ProfilerSettings
        : public Settings
    {
    public:

        //////////////////////////////////////////
        MAZE_DECLARE_METACLASS_WITH_PARENT(ProfilerSettings, Settings);

        //////////////////////////////////////////
        MAZE_DECLARE_MEMORY_ALLOCATION(ProfilerSettings);
...
#endif // _MazeProfilerSettings_hpp_
//////////////////////////////////////////
